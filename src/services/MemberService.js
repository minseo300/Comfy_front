...
export async function login(idToken){
    ...
    const response=await axios.get(`http://spring-boot-docker-service.test.svc.cluster.local/login/google/${idToken}`).then((response)=>{
...
export async function logout(){
    ...
    const response=axios.delete(`http://spring-boot-docker-service.test.svc.cluster.local/logout/${localStorage.getItem('memberId')}`);
