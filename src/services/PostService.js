...
export async function getPosts(){
    ...
    const response=await axios.get(`http://spring-boot-docker-service.test.svc.cluster.local/community/${memberId}`);
...
export async function getMyPagePosts(){
    ...
    const response=await axios.get(`http://spring-boot-docker-service.test.svc.cluster.local/myPage/${memberId}`,{headers:config});
...
export async function deleteMyPost(postId){
    ...
    const response=await axios.delete(`http://spring-boot-docker-service.test.svc.cluster.local/post/${postId}/${memberId}`,{headers:config});
...
export async function addBookmark(postId){
    ...
    const response=await axios.post('http://spring-boot-docker-service.test.svc.cluster.local/bookmark',data,{headers:config});
...
export async function deleteBookmark(postId){
    ...
    const response=await axios.delete(`http://spring-boot-docker-service.test.svc.cluster.local/bookmark/${postId}/${memberId}`,{headers:config},{});
...
export async function getPostInfo(postId){
    ...
    const response=await axios.get(`http://spring-boot-docker-service.test.svc.cluster.local/post/${postId}/${memberId}`,{headers:config});
...
export async function createPost(title,content,surveyId){
    const response=await axios.post(
        "http://spring-boot-docker-service.test.svc.cluster.local/posting",{
            title:title,
            contents:content,
            memberId:localStorage.getItem('memberId'),
            surveyId:surveyId
...
export async function getSearchedPosts(word){
    const response = await axios.get(
        "http://spring-boot-docker-service.test.svc.cluster.local/search?word=" + word,{
          params:{
              title:word
          }
        }
